...
'			Me.btnBetween.Click += New System.EventHandler(Me.btnBetween_Click);
			' 
			' btnRight
			' 
...
'			Me.cbBookmarks.SelectedValueChanged += New System.EventHandler(Me.cbBookmarks_SelectedValueChanged);
			' 
			' Form1
			' 
